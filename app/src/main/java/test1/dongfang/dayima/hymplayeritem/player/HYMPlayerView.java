...
/**
 * Created by xdf on 16-10-31.mplements TextureView.SurfaceTextureListener
 */
public class HYMPlayerView extends RelativeLayout implements View.OnClickListener, TextureView.SurfaceTextureListener {
    ...
    private String TAG = "HYMPlayerView";

    public HYMPlayerView(Context context) {
        this(context, null);
    }

    public HYMPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HYMPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        //先绑定ButterKnife
        inflate(context, R.layout.video_player_view_layout2, this);
    ...
    private void updatePlayProgress() {
        ...
        try {
            ...
            Toast.makeText(context,"update play progress failure",Toast.LENGTH_SHORT).show();
...
//    public HYMPlayerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//                mMediaPlayer.setDataSource(file.getAbsolutePath());
                mMediaPlayer.setDataSource("http://192.168.124.91:8080/ansen.mp4");
                mMediaPlayer.setSurface(mSurface1);
